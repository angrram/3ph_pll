#ifndef __dsogi_pll_3ph_sfun_h__
#define __dsogi_pll_3ph_sfun_h__
...
extern mxArray* load_dsogi_pll_3ph_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_dsogi_pll_3ph_optimization_info(void);
